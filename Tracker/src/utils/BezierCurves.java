...
public class BezierCurves {
	...
	public static double quadraticBezier(double p0, double p1, double p2, double t) {
		
		return pow(1 - t, 2) * p0 + 2 * (1 - t) * t * p1 + pow(t, 2) * p2;
		
	}
	
	public static Vector2 quadraticBezier(Vector2 p0, Vector2 p1, Vector2 p2, double t) {
		
		return new Vector2(quadraticBezier(p0.x, p1.x, p2.x, t), quadraticBezier(p0.y, p1.y, p2.y, t));
		
	}
	
	public static double quadraticBezierDerivative(double p0, double p1, double p2, double t) {
		
		return 2 * (1 - t) * (p1 - p0) + 2 * t * (p2 - p1);
		
	}
	
	public static Vector2 quadraticBezierDerivative(Vector2 p0, Vector2 p1, Vector2 p2, double t) {
		
		return new Vector2(quadraticBezierDerivative(p0.x, p1.x, p2.x, t), quadraticBezierDerivative(p0.y, p1.y, p2.y, t));
		
	}
	
	public static double quadraticBezierSecondDerivative(double p0, double p1, double p2, double t) {
		
		return 2 * (p2 - 2 * p1 + p0);
		
	}
	
	public static Vector2 quadraticBezierSecondDerivative(Vector2 p0, Vector2 p1, Vector2 p2, double t) {
		
		return new Vector2(quadraticBezierSecondDerivative(p0.x, p1.x, p2.x, t), quadraticBezierSecondDerivative(p0.y, p1.y, p2.y, t));
		
	}
	
	public static double quadraticBezierArcLength(Vector2 p0, Vector2 p1, Vector2 p2, int resolution) {
	...
	public static Vector2 cubicBezier(Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3, double t) {
	...
	public static Vector2 cubicBezierDerivative(Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3, double t) {
		
		return new Vector2(cubicBezierDerivative(p0.x, p1.x, p2.x, p3.x, t), cubicBezierDerivative(p0.y, p1.y, p2.y, p3.y, t));
		
	}
	
	public static double cubicBezierSecondDerivative(double p0, double p1, double p2, double p3, double t) {
		
		return 6 * (1 - t) * (p2 - 2 * p1 - p0) + 6 * t * (p3 - 2 * p2 + p1);
		
	}
	
	public static Vector2 cubicBezierSecondDerivative(Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3, double t) {
		
		return new Vector2(cubicBezierSecondDerivative(p0.x, p1.x, p2.x, p3.x, t), cubicBezierSecondDerivative(p0.y, p1.y, p2.y, p3.y, t));
		
	}
	
	public static double cubicBezierArcLength(Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3, int resolution) {
	...
	public static double cubicClosesAproach(int resolution, Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3, Vector2 to) {
	...
	public static double cubicClosesAproach(Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3, Vector2 to) {
